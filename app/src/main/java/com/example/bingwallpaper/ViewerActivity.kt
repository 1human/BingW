...
class ViewerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        wallpapers = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            intent.getSerializableExtra("WALLPAPER_LIST", ArrayList::class.java) as? List<WallpaperData>
        } else {
            intent.getSerializableExtra("WALLPAPER_LIST") as? List<WallpaperData>
        } ?: return finish()
